export const PROJECTS = [
  {
    ...
    caseStudy: {
      challenge: 'Turn a constant stream of market news into controlled, reviewable decisions without allowing an AI model to trade freely.',
      ownership: 'News ingestion, LLM classification, technical checks, risk rules, paper-trading integration, monitoring and the user dashboard.',
      evidence: [
      ...
      decisions: [
        { title: 'Keep a person in control', rationale: 'The system prepares a trade, but a person must approve it before it reaches the paper account.' },
        { title: 'Do not trust news alone', rationale: 'A signal must also pass technical checks, and the combined confidence must reach 55%.' },
        { title: 'Limit damage before chasing returns', rationale: 'Each trade is capped at 10% of equity, total exposure at 50%, with a 400 USD kill switch.' },
      ],
    },
    highlights: [
      'News is collected every 15 minutes and queued in Redis',
      'LLM and technical signals are combined before a trade is proposed',
      'Risk checks and manual approval protect the Alpaca paper account',
    ],
    proofs: [
  ...
  },
  {
    ...
    description:
      'A question-answering system built on 73 AI research papers. It combines keyword and meaning-based search, reranks the best matches, generates an answer with sources, and records quality and speed in an evaluation dashboard.',
    ...
    caseStudy: {
      challenge: 'Find the right evidence in technical papers and make answer quality visible instead of judging the system by a polished demo.',
      ownership: 'Document ingestion, hybrid retrieval, reranking, answer generation, query logging, evaluation and dashboard deployment.',
      evidence: [
      ...
      decisions: [
        ...
        { title: 'Rerank before answering', rationale: 'The system retrieves 20 candidates, then a second model chooses the best three for the final answer.' },
        { title: 'Show quality over time', rationale: 'Queries, response times and judge scores are stored so weak answers and corpus gaps are easy to find.' },
      ],
    },
    highlights: [
      '10-query evaluation reported in the repository',
      '73-paper corpus with 20 candidates reranked to three passages',
      'LLM-judge dashboard with query history and quality trends',
    ],
    proofs: [
  ...
  },
  {
    ...
    description:
      'A fine-tuning pipeline for Qwen2.5-3B that learns Arabic-English code-switching used in Gulf workplaces. It prepares the dataset, trains lightweight adapters, tracks experiments with MLflow, and compares the base and fine-tuned models on the same prompts.',
    ...
    caseStudy: {
      challenge: 'Base models often replace useful English business and technical terms with formal Arabic, losing the way Gulf professionals naturally communicate.',
      ownership: 'Data preparation, synthetic example generation, QLoRA training, MLflow tracking, model comparison and model publishing.',
      evidence: [
      ...
      decisions: [
        { title: 'Use Qwen2.5 as the base model', rationale: 'Its stronger Arabic foundation means less task-specific data is needed to learn the target style.' },
    ...
    highlights: [
      'Code-switch ratio rose from 5.1% to 34.7% across four stored prompts',
      '653 clean examples produced from 7,620 source instructions',
      'Three training epochs, final loss 1.388, approximately six minutes on M5 Max',
    ],
    proofs: [
